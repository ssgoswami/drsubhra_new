...
export const fullPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "If you are still weighing Europe against the USA, the comparison guide will help you decide which direction fits your goals and profile.",
        linkText: "Europe vs USA for Indian Students: How to Choose for Higher Studies",
        linkHref: "/blog/europe-vs-usa-indian-students-higher-studies",
      },
      {
        type: "cta",
        text: "Once you have a sense of direction, the profile building guide explains what you need to develop and strengthen before you apply.",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "With your profile taking shape, the next step is learning how to write a Statement of Purpose that presents it clearly and convincingly.",
        linkText: "How to Write a Strong SOP for Master's Abroad",
        linkHref: "/blog/write-strong-sop-masters-abroad",
      },
      {
        type: "cta",
        text: "For a full overview of the preparation journey - timelines, documents, and what to expect - read the study abroad preparation guide.",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "For a focused guide to the mistakes that weaken most SOPs - and how to catch them before you submit - read the common mistakes article.",
        linkText: "Statement of Purpose: Common Mistakes to Avoid",
        linkHref: "/blog/sop-common-mistakes",
      },
      {
        type: "cta",
        text: "If you are still building the academic profile that sits behind your SOP, the profile building guide explains what to focus on.",
        linkText: "How to Build a Strong Profile for Universities Abroad",
        linkHref: "/blog/build-strong-profile-universities-abroad",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "If you are still deciding between Europe and the USA, the comparison guide will help you match your goals and profile to the right destination.",
        linkText: "Europe vs USA for Indian Students: How to Choose for Higher Studies",
        linkHref: "/blog/europe-vs-usa-indian-students-higher-studies",
      },
      {
        type: "cta",
        text: "For a full overview of the preparation steps, documents, and timelines involved in applying abroad, read the study abroad preparation guide.",
        linkText: "How Indian Students Can Prepare to Study Abroad",
        linkHref: "/blog/study-abroad-preparation-indian-students",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "Ready to apply to the USA? The step-by-step guide covers the full US Master's application process for Indian students.",
        linkText: "How to Apply for a Master's in the USA from India",
        linkHref: "/blog/apply-masters-usa-from-india",
      },
      {
        type: "cta",
        text: "Ready to apply to Europe? The step-by-step guide covers how the process works across Germany, France, Netherlands, Sweden, and beyond.",
        linkText: "How to Apply for a Master's in Europe from India",
        linkHref: "/blog/apply-masters-europe-from-india",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "If you are still deciding between the USA and Europe, the comparison guide will help you think through the differences that matter most.",
        linkText: "Europe vs USA for Indian Students: How to Choose for Higher Studies",
        linkHref: "/blog/europe-vs-usa-indian-students-higher-studies",
      },
      {
        type: "cta",
        text: "Your SOP is often the deciding factor in a competitive US application. Read the full guide to writing one that is specific, honest, and convincing.",
        linkText: "How to Write a Strong SOP for Master's Abroad",
        linkHref: "/blog/write-strong-sop-masters-abroad",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "If you are still deciding between Europe and the USA, the comparison guide covers the key differences in cost, funding, program structure, and post-study outcomes.",
        linkText: "Europe vs USA for Indian Students: How to Choose for Higher Studies",
        linkHref: "/blog/europe-vs-usa-indian-students-higher-studies",
      },
      {
        type: "cta",
        text: "Your motivation letter is the most important document in most European applications. Read the full guide on writing an SOP that is specific and convincing.",
        linkText: "How to Write a Strong SOP for Master's Abroad",
        linkHref: "/blog/write-strong-sop-masters-abroad",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "The profile you bring to a supervisor outreach conversation matters. The profile building guide explains what to develop and how to present your research background credibly.",
        linkText: "How to Build a Strong Profile for Universities Abroad",
        linkHref: "/blog/build-strong-profile-universities-abroad",
      },
      {
        type: "cta",
        text: "Research methodology literacy is one of the qualities strong PhD supervisors look for. This guide explains what it means and how to develop it.",
        linkText: "Research Methodology Skills for University Students",
        linkHref: "/blog/research-methodology-skills-university-students",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "Research methodology skills are fundamental to building the kind of research profile that makes a postdoc application compelling. This guide explains what those skills are and how to develop them.",
        linkText: "Research Methodology Skills for University Students",
        linkHref: "/blog/research-methodology-skills-university-students",
      },
      {
        type: "cta",
        text: "If you are an early-stage researcher also thinking about PhD applications and supervisor search, this guide covers the full process.",
        linkText: "PhD Applications: Finding the Right Supervisor",
        linkHref: "/blog/finding-right-phd-supervisor",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "If you would like personalized guidance on your SOP - reviewing your draft, identifying weaknesses, and strengthening your argument - my mentorship program is designed for exactly this kind of work.",
        linkText: "Explore the Mentorship Program",
        linkHref: "/mentorship",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "cta",
        text: "Strong research methodology skills are most visible in your profile, your project write-ups, and how you discuss your work in applications. The profile building guide explains how to develop and present what you have built.",
        linkText: "How to Build a Strong Profile for Universities Abroad",
        linkHref: "/blog/build-strong-profile-universities-abroad",
      },
    ],
